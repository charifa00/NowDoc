...
<head>
 ...
 <div class="bg p-3">
    ...
    <div class="container">
        <header class="my-4">
            <h1 class="text-center text-white ">Prenez rendez-vous chez un médecin ou un dentiste</h1>
        </header>
        <main>
            <!-- Table avec les classes Bootstrap -->
                    ...
                    <tbody>
                        <c:forEach items="${medecins}" var="medecin">
                            <tr>
                                ...
                                <td>${medecin.specialites}</td>
                                <td>${medecin.ville}</td>

                                <td>
                                    <a href="ajouterRendezVous?medecinId=${medecin.id}"
                                       class="btn btn-primary btn-sm" role="button" aria-label="Ajouter un rendez-vous">Ajouter Rendez-vous</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
